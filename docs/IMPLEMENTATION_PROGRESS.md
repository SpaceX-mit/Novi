...
| 自动化门禁 | 测试、语法、OpenAPI、供应商/存储契约、浏览器、SBOM、依赖与镜像扫描、release-check | 最近记录：81 passed + 1 PostgreSQL 条件跳过；47 个 JavaScript 模块语法通过；OpenAPI 47 paths / 59 operations；锁文件 SBOM 422 components / 129 runtime；开发/打包 Electron、desktop/mobile 浏览器、Provider 与存储契约通过 |
