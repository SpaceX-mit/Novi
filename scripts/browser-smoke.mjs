...
try {
  ...
  if (conversationUi.artifacts !== 1 || conversationUi.artifactLinks !== 1 || !conversationUi.lastKind.includes('artifact') || conversationUi.wikiDocuments !== 7 || conversationUi.runEvents < 10 || conversationUi.errors !== 0 || !conversationUi.trace.includes('LLM response') || !conversationUi.trace.includes('Artifact saved') || !conversationUi.details.includes('Browser Harness response')) throw new Error(`Composer did not create an auditable cumulative Wiki artifact: ${JSON.stringify(conversationUi)}`);
